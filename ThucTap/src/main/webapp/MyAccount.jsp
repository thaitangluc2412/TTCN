                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="coupon-info">
                                            ...
                                            <p class="coupon-text">To add a new address, please fill out the form
                                                                   below.</p>
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="coupon-info">
                                            ...
                                            <p class="coupon-text">Here are the orders you've placed since your account
                                                                   was created.</p>
                                ...
                                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="coupon-info">
                                            ...
                                            <p class="coupon-text">Please be sure to update your personal information if
                                                                   it has changed.</p>
                                            <p class="required">*Required field</p>
                                            <form action="#">
                                                <div class="form-row">
